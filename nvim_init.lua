...
require("lazy").setup({
...

	{
		...
		config = function()
			...
			vim.keymap.set("n", "<leader>hv", ":HopVertical<CR>")
...

	{
		...
		config = function()
			vim.keymap.set("n", "<leader>nn", ":Neotree position=float<CR>")
			vim.keymap.set("n", "<leader>nf", ":Neotree float reveal_force_cwd<CR>")
			vim.keymap.set("n", "<leader>nb", ":Neotree buffers position=float<CR>")
			vim.keymap.set("n", "<leader>ng", ":Neotree git_status position=float<CR>")
		end,
	},
